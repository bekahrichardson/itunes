angular.module('itunes').service('itunesService', function($http, $q){
  ...
  //You can return the http request or you can make your own promise in order to manipulate the data before you resolve it.
    ...
    //Code here
    this.gridOptions = function(artistName) {
      return $http({
        method: 'JSONP',
...
// index page has <input type="text" class="form-control" ng-model="artist" placeholder="Artist Name" > "Artist Name" Do I use this?
